...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-sans bg-[var(--background)] text-[var(--foreground)]">
      <h1 className="text-3xl font-bold row-start-1 text-[var(--accent)]">Rick & Morty</h1>
      <main className="grid grid-cols-1 gap-8 sm:grid-cols-3 row-start-2 w-full">
        <div className="flex flex-col items-center sm:items-start">
          <h2 className="text-2xl font-semibold mb-4 text-[var(--secondary-accent)]">Characters</h2>
          <ItemList items={characters} category={CATEGORIES.character} />
        </div>
        <div className="flex flex-col items-center sm:items-start">
          <h2 className="text-2xl font-semibold mb-4 text-[var(--secondary-accent)]">Episodes</h2>
          <ItemList items={episodes} category={CATEGORIES.episode} />
        </div>
        <div className="flex flex-col items-center sm:items-start">
          <h2 className="text-2xl font-semibold mb-4 text-[var(--secondary-accent)]">Locations</h2>
